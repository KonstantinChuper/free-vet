const text_en = {
  ...
  registrationPage: {
    ...
    privacyPolicyText:
      "By clicking the Send code button, you agree to the<br></br>Privacy Policy",
  },
  phoneLoginPage: {
  ...
  l_createVetBookPage: {
    ...
    noBook:
      "It seems that your pet<br></br>doesn't have a digital veterinary book yet :(",
    petName: "Pet's Name",
    ...
    vetBook_description:
      "The veterinary book is a digital version of the pet's passport<br></br>with useful features,<br></br>simplifying the care process.",
  ...
  closeQuestionPage: {
    ...
    ratingPrompt:
      "Please rate the veterinarian's responses <br /> on a scale from 1 to 10, <br /> where 1 - not at all liked, <br /> 10 - everything was great! &#42",
  ...
  mainHeader: {
    ...
    description:
      "A service of the TailBook ecosystem that allows you to ask qualified and experienced veterinarians questions for free and receive answers.",
  },
  verificationPage: {
    header: "Phone Verification",
    enterCode:
      "Please enter the code you received<br></br>on the specified phone",
    confirm: "Confirm",
  },
  vetVerificationPage: {
    header: "Verification",
    notAuthorized:
      "It seems you are not authorized<br></br>in the service as a specialist :(",
    additionalData:
      "Please provide additional data,<br></br>for your authorization as a specialist",
    nameLabel: "Full Name",
    nameRequired: "Name is required",
    nameMinLength: "Minimum two characters",
    documentsLabel:
      "Please add documents,<br></br>confirming your qualifications",
    ...
    petArtLabel:
      "Specify the animals (cats, dogs, etc.)<br></br>that you specialize in",
  ...
  accordion: {
    ...
    clinicDewormingLabel:
      "Clinic where deworming was performed (or self-performed)",
