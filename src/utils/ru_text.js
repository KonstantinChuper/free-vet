...
const texts = {
  ...
  registrationPage: {
    ...
    privacyPolicyText:
      "Нажимая на кнопку Отправить код, Вы соглашаетесь<br></br>с Политикой конфиденциальности",
  },
  phoneLoginPage: {
    header: "Вход по номеру телефона",
    subtitle:
      "Пожалуйста введите номер телефона,<br></br>по которому Вы зарегистрированы",
  ...
  l_createVetBookPage: {
    ...
    noBook:
      "Похоже, что у Вашего любимца<br></br>еще нет цифровой ветеринарной книжки :(",
    petName: "Имя Любимца",
    ...
    vetBook_description:
      "Ветеринарная книжка -<br></br>это цифровая версия паспорта животного<br></br>с полезными функциями,<br></br>упрощающими процесс заботы",
  ...
  closeQuestionPage: {
    ...
    ratingPrompt:
      "Пожалуйста, оцените ответы ветеринарного врача <br /> по шкале от 1 до 10, <br /> где 1 - совсем не понравилось, <br /> 10 - все супер! &#42",
  ...
  mainHeader: {
    ...
    description:
      "Сервис экосистемы TailBook, предоставляющий возможность бесплатно задавать вопросы квалифицированным опытным ветеринарным врачам и получать ответы на них.",
  },
  verificationPage: {
    header: "Проверка телефона",
    enterCode:
      "Пожалуйста введите полученный Вами<br></br>на указанный телефон код",
    confirm: "Подтвердить",
  },
  vetVerificationPage: {
    header: "Верификация",
    notAuthorized:
      "Похоже, что у Вы еще не авторизованы<br></br>в сервисе в качестве специалиста :(",
    additionalData:
      "Пожалуйста, укажите дополнительные данные,<br></br>для авторизации Вас в качестве специалиста",
    nameLabel: "Имя и Фамилия полностью",
    nameRequired: "Имя обязательно",
    nameMinLength: "Минимум два символа",
    documentsLabel:
      "Подалуйста, добавьте документы,<br></br>подтверждающие Вашу квалификацию",
    ...
    petArtLabel:
      "Укажите животных (кошки, собаки и т.д.),<br></br>на помощи которым Вы специализируетесь",
  ...
  accordion: {
    ...
    clinicDewormingLabel:
      "Клиника, в которой проведена обработка (либо самостоятельно)",
